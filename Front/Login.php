<html>
	...
	<body>
		...
		?>
			...
			<div class="titulo" align='center'>Inicio de sesión tienda</div><br>
			<div class='container'>
				<div class='wrapper'>
					...
					<div class='row'>
						...
						<input type = 'text', name = 'correo', id = 'correo', placeholder = 'Correo@Dominio'/>
					</div>
					<div class='row'>
						<i class='fas fa-user'></i>
					...
					<input onclick="location='Registro.php'" value='Registrar cuenta'>
					</div>
					<div class='row button'>
